...
void protobuf_AddDesc_cartographer_2fmapping_2fproto_2fsparse_5fpose_5fgraph_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    ...
    ".Rigid3d\022\023\n\013sqrt_Lambda\030\004 \003(\001\022G\n\003tag\030\005 \001"
    "(\0162:.cartographer.mapping.proto.SparsePo"
    "seGraph.Constraint.Tag\0327\n\010SubmapId\022\025\n\rtr"
    "ajectory_id\030\001 \001(\005\022\024\n\014submap_index\030\002 \001(\005\032"
    "3\n\006ScanId\022\025\n\rtrajectory_id\030\001 \001(\005\022\022\n\nscan"
    "_index\030\002 \001(\005\")\n\003Tag\022\020\n\014INTRA_SUBMAP\020\000\022\020\n"
    "\014INTER_SUBMAP\020\001", 815);
  ...
  while ((tag = input->ReadTag()) != 0) {
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 3: {
        ...
        if (input->ExpectTag(33)) goto parse_sqrt_Lambda;
        break;
      }

      // repeated double sqrt_Lambda = 4;
      case 4: {
        if (::google::protobuf::internal::WireFormatLite::GetTagWireType(tag) ==
         ...
         parse_sqrt_Lambda:
          DO_((::google::protobuf::internal::WireFormatLite::ReadRepeatedPrimitive<
                 ...
                 1, 33, input, this->mutable_sqrt_lambda())));
...
::google::protobuf::uint8* SparsePoseGraph_Constraint::SerializeWithCachedSizesToArray(
  ...
  for (int i = 0; i < this->sqrt_lambda_size(); i++) {
    target = ::google::protobuf::internal::WireFormatLite::
      WriteDoubleToArray(4, this->sqrt_lambda(i), target);
  }
...
int SparsePoseGraph_Constraint::ByteSize() const {
  ...
  // repeated double sqrt_Lambda = 4;
  {
    ...
    total_size += 1 * this->sqrt_lambda_size() + data_size;
  }
