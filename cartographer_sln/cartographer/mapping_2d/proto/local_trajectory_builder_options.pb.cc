...
void protobuf_AssignDesc_cartographer_2fmapping_5f2d_2fproto_2flocal_5ftrajectory_5fbuilder_5foptions_2eproto() {
  ...
  static const int LocalTrajectoryBuilderOptions_offsets_[15] = {
    ...
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(LocalTrajectoryBuilderOptions, laser_min_z_),
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(LocalTrajectoryBuilderOptions, laser_max_z_),
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(LocalTrajectoryBuilderOptions, laser_missing_echo_ray_length_),
...
void protobuf_AddDesc_cartographer_2fmapping_5f2d_2fproto_2flocal_5ftrajectory_5fbuilder_5foptions_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    ...
    "ns\022\027\n\017laser_min_range\030\016 \001(\002\022\027\n\017laser_max"
    "_range\030\017 \001(\002\022\023\n\013laser_min_z\030\001 \001(\002\022\023\n\013las"
    "er_max_z\030\002 \001(\002\022%\n\035laser_missing_echo_ray"
    "_length\030\020 \001(\002\022\037\n\027laser_voxel_filter_size"
    "\030\003 \001(\002\022,\n$use_online_correlative_scan_ma"
    "tching\030\005 \001(\010\022\\\n\035adaptive_voxel_filter_op"
    "tions\030\006 \001(\01325.cartographer.sensor.proto."
    "AdaptiveVoxelFilterOptions\022\206\001\n*real_time"
    "_correlative_scan_matcher_options\030\007 \001(\0132"
    "R.cartographer.mapping_2d.scan_matching."
    "proto.RealTimeCorrelativeScanMatcherOpti"
    "ons\022h\n\032ceres_scan_matcher_options\030\010 \001(\0132"
    "D.cartographer.mapping_2d.scan_matching."
    "proto.CeresScanMatcherOptions\022Q\n\025motion_"
    "filter_options\030\r \001(\01322.cartographer.mapp"
    "ing_3d.proto.MotionFilterOptions\022!\n\031imu_"
    "gravity_time_constant\030\021 \001(\001\022\033\n\023num_odome"
    "try_states\030\022 \001(\005\022F\n\017submaps_options\030\013 \001("
    "\0132-.cartographer.mapping_2d.proto.Submap"
    "sOptions\022\024\n\014use_imu_data\030\014 \001(\010", 1270);
...
const int LocalTrajectoryBuilderOptions::kLaserMinZFieldNumber;
const int LocalTrajectoryBuilderOptions::kLaserMaxZFieldNumber;
const int LocalTrajectoryBuilderOptions::kLaserMissingEchoRayLengthFieldNumber;
...
void LocalTrajectoryBuilderOptions::SharedCtor() {
  ...
  laser_min_z_ = 0;
  laser_max_z_ = 0;
  laser_missing_echo_ray_length_ = 0;
  ...
  while ((tag = input->ReadTag()) != 0) {
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 1: {
        ...
        if (input->ExpectTag(21)) goto parse_laser_max_z;
        break;
      }
      ...
      case 2: {
        ...
        if (input->ExpectTag(29)) goto parse_laser_voxel_filter_size;
        break;
      }
      ...
      case 13: {
        ...
        if (input->ExpectTag(117)) goto parse_laser_min_range;
        break;
      }
      ...
      case 14: {
        ...
        if (input->ExpectTag(125)) goto parse_laser_max_range;
        break;
      }
      ...
      case 15: {
        ...
        if (input->ExpectTag(133)) goto parse_laser_missing_echo_ray_length;
        break;
      }
      ...
      case 16: {
        if (::google::protobuf::internal::WireFormatLite::GetTagWireType(tag) ==
            ::google::protobuf::internal::WireFormatLite::WIRETYPE_FIXED32) {
         parse_laser_missing_echo_ray_length:
          DO_((::google::protobuf::internal::WireFormatLite::ReadPrimitive<
                   float, ::google::protobuf::internal::WireFormatLite::TYPE_FLOAT>(
                 input, &laser_missing_echo_ray_length_)));
          set_has_laser_missing_echo_ray_length();
        } else {
          goto handle_uninterpreted;
        }
...
void LocalTrajectoryBuilderOptions::SerializeWithCachedSizes(
  ...
  // optional float laser_min_z = 1;
  if (has_laser_min_z()) {
    ::google::protobuf::internal::WireFormatLite::WriteFloat(1, this->laser_min_z(), output);
  }

  // optional float laser_max_z = 2;
  if (has_laser_max_z()) {
    ::google::protobuf::internal::WireFormatLite::WriteFloat(2, this->laser_max_z(), output);
  }

  // optional float laser_voxel_filter_size = 3;
  if (has_laser_voxel_filter_size()) {
    ::google::protobuf::internal::WireFormatLite::WriteFloat(3, this->laser_voxel_filter_size(), output);
  }
  ...
  if (has_laser_min_range()) {
    ::google::protobuf::internal::WireFormatLite::WriteFloat(14, this->laser_min_range(), output);
  }

  // optional float laser_max_range = 15;
  if (has_laser_max_range()) {
    ::google::protobuf::internal::WireFormatLite::WriteFloat(15, this->laser_max_range(), output);
  }

  // optional float laser_missing_echo_ray_length = 16;
  if (has_laser_missing_echo_ray_length()) {
    ::google::protobuf::internal::WireFormatLite::WriteFloat(16, this->laser_missing_echo_ray_length(), output);
  }
...
::google::protobuf::uint8* LocalTrajectoryBuilderOptions::SerializeWithCachedSizesToArray(
  ...
  // optional float laser_min_z = 1;
  if (has_laser_min_z()) {
    target = ::google::protobuf::internal::WireFormatLite::WriteFloatToArray(1, this->laser_min_z(), target);
  }

  // optional float laser_max_z = 2;
  if (has_laser_max_z()) {
    target = ::google::protobuf::internal::WireFormatLite::WriteFloatToArray(2, this->laser_max_z(), target);
  }

  // optional float laser_voxel_filter_size = 3;
  if (has_laser_voxel_filter_size()) {
    target = ::google::protobuf::internal::WireFormatLite::WriteFloatToArray(3, this->laser_voxel_filter_size(), target);
  }
  ...
  // optional float laser_min_range = 14;
  if (has_laser_min_range()) {
    target = ::google::protobuf::internal::WireFormatLite::WriteFloatToArray(14, this->laser_min_range(), target);
  }

  // optional float laser_max_range = 15;
  if (has_laser_max_range()) {
    target = ::google::protobuf::internal::WireFormatLite::WriteFloatToArray(15, this->laser_max_range(), target);
  }

  // optional float laser_missing_echo_ray_length = 16;
  if (has_laser_missing_echo_ray_length()) {
    target = ::google::protobuf::internal::WireFormatLite::WriteFloatToArray(16, this->laser_missing_echo_ray_length(), target);
  }
...
void LocalTrajectoryBuilderOptions::MergeFrom(const LocalTrajectoryBuilderOptions& from) {
  ...
  if (from._has_bits_[0 / 32] & (0xffu << (0 % 32))) {
    ...
    if (from.has_laser_min_z()) {
      set_laser_min_z(from.laser_min_z());
    }
    if (from.has_laser_max_z()) {
      set_laser_max_z(from.laser_max_z());
    }
    if (from.has_laser_missing_echo_ray_length()) {
      set_laser_missing_echo_ray_length(from.laser_missing_echo_ray_length());
    }
...
void LocalTrajectoryBuilderOptions::Swap(LocalTrajectoryBuilderOptions* other) {
  if (other != this) {
    ...
    std::swap(laser_min_z_, other->laser_min_z_);
    std::swap(laser_max_z_, other->laser_max_z_);
    std::swap(laser_missing_echo_ray_length_, other->laser_missing_echo_ray_length_);
