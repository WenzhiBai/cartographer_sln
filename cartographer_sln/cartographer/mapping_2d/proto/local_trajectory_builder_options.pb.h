...
class LocalTrajectoryBuilderOptions : public ::google::protobuf::Message {
 public:
  ...
  static const int kLaserMinRangeFieldNumber = 14;
  ...
  static const int kLaserMaxRangeFieldNumber = 15;
  inline float laser_max_range() const;
  inline void set_laser_max_range(float value);

  // optional float laser_min_z = 1;
  inline bool has_laser_min_z() const;
  inline void clear_laser_min_z();
  static const int kLaserMinZFieldNumber = 1;
  inline float laser_min_z() const;
  inline void set_laser_min_z(float value);

  // optional float laser_max_z = 2;
  inline bool has_laser_max_z() const;
  inline void clear_laser_max_z();
  static const int kLaserMaxZFieldNumber = 2;
  inline float laser_max_z() const;
  inline void set_laser_max_z(float value);

  // optional float laser_missing_echo_ray_length = 16;
  inline bool has_laser_missing_echo_ray_length() const;
  inline void clear_laser_missing_echo_ray_length();
  static const int kLaserMissingEchoRayLengthFieldNumber = 16;
  inline float laser_missing_echo_ray_length() const;
  inline void set_laser_missing_echo_ray_length(float value);
  ...
  static const int kLaserVoxelFilterSizeFieldNumber = 3;
 ...
 private:
  ...
  inline void set_has_laser_min_z();
  inline void clear_has_laser_min_z();
  inline void set_has_laser_max_z();
  inline void clear_has_laser_max_z();
  inline void set_has_laser_missing_echo_ray_length();
  inline void clear_has_laser_missing_echo_ray_length();
  ...
  float laser_min_z_;
  float laser_max_z_;
  float laser_missing_echo_ray_length_;
...
// optional float laser_min_z = 1;
inline bool LocalTrajectoryBuilderOptions::has_laser_min_z() const {
  return (_has_bits_[0] & 0x00000004u) != 0;
}
inline void LocalTrajectoryBuilderOptions::set_has_laser_min_z() {
  _has_bits_[0] |= 0x00000004u;
}
inline void LocalTrajectoryBuilderOptions::clear_has_laser_min_z() {
  _has_bits_[0] &= ~0x00000004u;
}
inline void LocalTrajectoryBuilderOptions::clear_laser_min_z() {
  laser_min_z_ = 0;
  clear_has_laser_min_z();
}
inline float LocalTrajectoryBuilderOptions::laser_min_z() const {
  return laser_min_z_;
}
inline void LocalTrajectoryBuilderOptions::set_laser_min_z(float value) {
  set_has_laser_min_z();
  laser_min_z_ = value;
}

// optional float laser_max_z = 2;
inline bool LocalTrajectoryBuilderOptions::has_laser_max_z() const {
  return (_has_bits_[0] & 0x00000008u) != 0;
}
inline void LocalTrajectoryBuilderOptions::set_has_laser_max_z() {
  _has_bits_[0] |= 0x00000008u;
}
inline void LocalTrajectoryBuilderOptions::clear_has_laser_max_z() {
  _has_bits_[0] &= ~0x00000008u;
}
inline void LocalTrajectoryBuilderOptions::clear_laser_max_z() {
  laser_max_z_ = 0;
  clear_has_laser_max_z();
}
inline float LocalTrajectoryBuilderOptions::laser_max_z() const {
  return laser_max_z_;
}
inline void LocalTrajectoryBuilderOptions::set_laser_max_z(float value) {
  set_has_laser_max_z();
  laser_max_z_ = value;
}

// optional float laser_missing_echo_ray_length = 16;
inline bool LocalTrajectoryBuilderOptions::has_laser_missing_echo_ray_length() const {
  return (_has_bits_[0] & 0x00000010u) != 0;
}
inline void LocalTrajectoryBuilderOptions::set_has_laser_missing_echo_ray_length() {
  _has_bits_[0] |= 0x00000010u;
}
inline void LocalTrajectoryBuilderOptions::clear_has_laser_missing_echo_ray_length() {
  _has_bits_[0] &= ~0x00000010u;
}
inline void LocalTrajectoryBuilderOptions::clear_laser_missing_echo_ray_length() {
  laser_missing_echo_ray_length_ = 0;
  clear_has_laser_missing_echo_ray_length();
}
inline float LocalTrajectoryBuilderOptions::laser_missing_echo_ray_length() const {
  return laser_missing_echo_ray_length_;
}
inline void LocalTrajectoryBuilderOptions::set_laser_missing_echo_ray_length(float value) {
  set_has_laser_missing_echo_ray_length();
  laser_missing_echo_ray_length_ = value;
}
